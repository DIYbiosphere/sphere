...
### How it works
The platform functions similar to a wiki, hosting the raw _files_ at [https://github.com/DIYbiosphere/sphere](https://github.com/DIYbiosphere/sphere) and building/rendering _webpages_ at [http://sphere.diybio.org](http://sphere.diybio.org) via Jekyll and Netlify
